...
lame_init_params(lame_global_flags * gfp)
{
    ...
    if (NULL == gfc->sv_rpg.rgdata)
        gfc->sv_rpg.rgdata = (replaygain_t*)calloc(1, sizeof(replaygain_t));
    if (NULL == gfc->sv_rpg.rgdata) {
        freegfc(gfc);
...
update_inbuffer_size(lame_internal_flags * gfc, const int nsamples)
{
    ...
    if (esv->in_buffer_0 == 0 || esv->in_buffer_nsamples < nsamples) {
        ...
        esv->in_buffer_0 = (sample_t*)calloc(nsamples, sizeof(sample_t));
        esv->in_buffer_1 = (sample_t*)calloc(nsamples, sizeof(sample_t));
...
lame_init_old(lame_global_flags * gfp)
{
    ...
    if (NULL == (gfc = gfp->internal_flags = (lame_internal_flags*)calloc(1, sizeof(lame_internal_flags))))
        return -1;
...
lame_init(void)
{
    ...
    gfp = (lame_global_flags*)calloc(1, sizeof(lame_global_flags));
    if (gfp == NULL)
        return NULL;
