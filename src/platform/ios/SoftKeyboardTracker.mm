...
- (void)tick:(CADisplayLink *)sender {
    ...
    float keyboardHeight = app._window->_surface->_size.height - keyboardTop;
    
    app._window->setUnsafeInsets(oak::UnsafeArea::SoftKeyboard, EDGEINSETS(0,0,0,keyboardHeight));
