...
/*void BNContainerModule::updateSubviewsForModules(vector<BNModule*> modules, View* superview) {
}
...
void BNContainerModule::updateSubviews(View* superview) {
	updateSubviewsForModules(_modules, superview);
}
void BNContainerModule::removeAllViews() {
