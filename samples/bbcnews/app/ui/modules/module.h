...
public:
    ...
    /*
     Called by the container when the module must check the visibility of its contents
     w.r.t. superview bounds and add/remove views from the superview as appropriate.
     */
