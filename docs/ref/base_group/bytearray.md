...
` bytearray(const `[`bytearray`](/ref/base_group/bytearray)` & src)`<br>

` bytearray(`[`bytearray`](/ref/base_group/bytearray)` && other)`<br>
...
[`bytearray`](/ref/base_group/bytearray)` & operator=(const `[`bytearray`](/ref/base_group/bytearray)` & str)`<br>

`void append(const `[`bytearray`](/ref/base_group/bytearray)` & str)`<br>
...
`void insert(int32_t offset, const `[`bytearray`](/ref/base_group/bytearray)` & str)`<br>
...
`class `[`string`](/ref/base_group/string)` toString()`<br>
