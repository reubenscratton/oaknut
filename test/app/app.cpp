...
void App::main() {
    ...
    View* view2 = new View();
    view2->setMeasureSpecs(MEASURESPEC::Fill(), MEASURESPEC::Fill());
    ...
    viewLeaf1->setMeasureSpecs(MEASURESPEC::Abs(10), MEASURESPEC::Abs(10));
    ...
    viewLeaf2->setMeasureSpecs(MEASURESPEC::Abs(10), MEASURESPEC::Abs(10));
    viewLeaf2->setAlignSpecs(ALIGNSPEC::ToRightOf(viewLeaf1, 2), ALIGNSPEC::Top());
    ...
    viewLeaf3->setMeasureSpecs(MEASURESPEC::Fill(), MEASURESPEC::Abs(10));
    viewLeaf3->setAlignSpecs(ALIGNSPEC::ToRightOf(viewLeaf2, 2), ALIGNSPEC::Top());
